...
export default function Onboarding() {
  ...
  return (
    <div className="app-shell-viewport flex min-h-screen items-center justify-center">
      <div
        className="app-shell-container relative flex min-h-[100dvh] w-full max-w-[430px] flex-col justify-between overflow-hidden pb-8 sm:my-8 sm:h-[calc(100dvh-4rem)] sm:rounded-[2.25rem] sm:shadow-2xl"
        style={{ background: "linear-gradient(180deg, #DCFCE7 0%, #ECFDF5 50%, #F0FDF4 100%)" }}
      >
        {/* Leaf sphere graphic */}
        <img src={leafSphere} alt="" className="leaf-sphere-graphic" />

        {/* Onboarding card wrapper - sits at bottom */}
        <div
          className="relative z-10 w-full px-5 pointer-events-none"
